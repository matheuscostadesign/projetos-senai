...
describe("Teste de validação validar_pontos INVALIDOS", function() {
  ...
  it("Validar Campeões ", function() {
	...
	expect( validar_pontos(3,1) ).not.toEqual ("Vitória do Time 2");	
	
	expect( validar_pontos(1,3) ).not.toEqual ("Vitória do Time 1");	
	
	expect( validar_pontos(3,1) ).not.toEqual ("Empate");
